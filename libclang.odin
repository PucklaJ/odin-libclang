...
CXErrorCode :: enum i32 {CXError_Success = 0, CXError_Failure = 1, CXError_Crashed = 2, CXError_InvalidArguments = 3, CXError_ASTReadError = 4, }
CXCompilationDatabase :: rawptr
CXCompileCommands :: rawptr
CXCompileCommand :: rawptr
CXCompilationDatabase_Error :: enum i32 {CXCompilationDatabase_NoError = 0, CXCompilationDatabase_CanNotLoadDatabase = 1, }
CXString :: struct {
    data: rawptr,
    private_flags: u32,
}
CXDiagnosticSeverity :: enum i32 {CXDiagnostic_Ignored = 0, CXDiagnostic_Note = 1, CXDiagnostic_Warning = 2, CXDiagnostic_Error = 3, CXDiagnostic_Fatal = 4, }
CXDiagnostic :: rawptr
CXDiagnosticSet :: rawptr
CXLoadDiag_Error :: enum i32 {CXLoadDiag_None = 0, CXLoadDiag_Unknown = 1, CXLoadDiag_CannotLoad = 2, CXLoadDiag_InvalidFile = 3, }
CXDiagnosticDisplayOptions :: enum i32 {CXDiagnostic_DisplaySourceLocation = 1, CXDiagnostic_DisplayColumn = 2, CXDiagnostic_DisplaySourceRanges = 4, CXDiagnostic_DisplayOption = 8, CXDiagnostic_DisplayCategoryId = 16, CXDiagnostic_DisplayCategoryName = 32, }
...
CXCommentKind :: enum i32 {CXComment_Null = 0, CXComment_Text = 1, CXComment_InlineCommand = 2, CXComment_HTMLStartTag = 3, CXComment_HTMLEndTag = 4, CXComment_Paragraph = 5, CXComment_BlockCommand = 6, CXComment_ParamCommand = 7, CXComment_TParamCommand = 8, CXComment_VerbatimBlockCommand = 9, CXComment_VerbatimBlockLine = 10, CXComment_VerbatimLine = 11, CXComment_FullComment = 12, }
CXCommentInlineCommandRenderKind :: enum i32 {CXCommentInlineCommandRenderKind_Normal = 0, CXCommentInlineCommandRenderKind_Bold = 1, CXCommentInlineCommandRenderKind_Monospaced = 2, CXCommentInlineCommandRenderKind_Emphasized = 3, CXCommentInlineCommandRenderKind_Anchor = 4, }
CXCommentParamPassDirection :: enum i32 {CXCommentParamPassDirection_In = 0, CXCommentParamPassDirection_Out = 1, CXCommentParamPassDirection_InOut = 2, }
CXAPISet :: rawptr
...
CXLinkageKind :: enum i32 {CXLinkage_Invalid = 0, CXLinkage_NoLinkage = 1, CXLinkage_Internal = 2, CXLinkage_UniqueExternal = 3, CXLinkage_External = 4, }
CXVisibilityKind :: enum i32 {CXVisibility_Invalid = 0, CXVisibility_Hidden = 1, CXVisibility_Protected = 2, CXVisibility_Default = 3, }
...
CXRefQualifierKind :: enum i32 {CXRefQualifier_None = 0, CXRefQualifier_LValue = 1, CXRefQualifier_RValue = 2, }
CX_CXXAccessSpecifier :: enum i32 {CX_CXXInvalidAccessSpecifier = 0, CX_CXXPublic = 1, CX_CXXProtected = 2, CX_CXXPrivate = 3, }
CX_StorageClass :: enum i32 {CX_SC_Invalid = 0, CX_SC_None = 1, CX_SC_Extern = 2, CX_SC_Static = 3, CX_SC_PrivateExtern = 4, CX_SC_OpenCLWorkGroupLocal = 5, CX_SC_Auto = 6, CX_SC_Register = 7, }
CXChildVisitResult :: enum i32 {CXChildVisit_Break = 0, CXChildVisit_Continue = 1, CXChildVisit_Recurse = 2, }
...
CXEvalResultKind :: enum i32 {CXEval_Int = 1, CXEval_Float = 2, CXEval_ObjCStrLiteral = 3, CXEval_StrLiteral = 4, CXEval_CFStr = 5, CXEval_Other = 6, CXEval_UnExposed = 0, }
CXEvalResult :: rawptr
CXRemapping :: rawptr
CXVisitorResult :: enum i32 {CXVisit_Break = 0, CXVisit_Continue = 1, }
anon_0 :: #type proc "c" (context_: rawptr, param1: CXCursor, param2: CXSourceRange) -> CXVisitorResult
CXCursorAndRangeVisitor :: struct {
    context_: rawptr,
    visit: anon_0,
}
CXResult :: enum i32 {CXResult_Success = 0, CXResult_Invalid = 1, CXResult_VisitBreak = 2, }
...
CXIdxDeclInfoFlags :: enum i32 {CXIdxDeclFlag_Skipped = 1, }
...
CXIdxObjCContainerKind :: enum i32 {CXIdxObjCContainer_ForwardRef = 0, CXIdxObjCContainer_Interface = 1, CXIdxObjCContainer_Implementation = 2, }
...
CXIdxEntityRefKind :: enum i32 {CXIdxEntityRef_Direct = 1, CXIdxEntityRef_Implicit = 2, }
CXSymbolRole :: enum i32 {CXSymbolRole_None = 0, CXSymbolRole_Declaration = 1, CXSymbolRole_Definition = 2, CXSymbolRole_Reference = 4, CXSymbolRole_Read = 8, CXSymbolRole_Write = 16, CXSymbolRole_Call = 32, CXSymbolRole_Dynamic = 64, CXSymbolRole_AddressOf = 128, CXSymbolRole_Implicit = 256, }
...
anon_1 :: #type proc "c" (client_data: CXClientData, reserved: rawptr) -> i32
anon_2 :: #type proc "c" (client_data: CXClientData, param1: CXDiagnosticSet, reserved: rawptr)
anon_3 :: #type proc "c" (client_data: CXClientData, mainFile: CXFile, reserved: rawptr) -> CXIdxClientFile
anon_4 :: #type proc "c" (client_data: CXClientData, param1: ^CXIdxIncludedFileInfo) -> CXIdxClientFile
anon_5 :: #type proc "c" (client_data: CXClientData, param1: ^CXIdxImportedASTFileInfo) -> CXIdxClientASTFile
anon_6 :: #type proc "c" (client_data: CXClientData, reserved: rawptr) -> CXIdxClientContainer
anon_7 :: #type proc "c" (client_data: CXClientData, param1: ^CXIdxDeclInfo)
anon_8 :: #type proc "c" (client_data: CXClientData, param1: ^CXIdxEntityRefInfo)
IndexerCallbacks :: struct {
    abortQuery: anon_1,
    diagnostic: anon_2,
    enteredMainFile: anon_3,
    ppIncludedFile: anon_4,
    importedASTFile: anon_5,
    startedTranslationUnit: anon_6,
    indexDeclaration: anon_7,
    indexEntityReference: anon_8,
}
CXIndexAction :: rawptr
CXIndexOptFlags :: enum i32 {CXIndexOpt_None = 0, CXIndexOpt_SuppressRedundantRefs = 1, CXIndexOpt_IndexFunctionLocalSymbols = 2, CXIndexOpt_IndexImplicitTemplateInstantiations = 4, CXIndexOpt_SuppressWarnings = 8, CXIndexOpt_SkipParsedBodiesInSession = 16, }
CXFieldVisitor :: #type proc "c" (C: CXCursor, client_data: CXClientData) -> CXVisitorResult
CXBinaryOperatorKind :: enum i32 {CXBinaryOperator_Invalid = 0, CXBinaryOperator_PtrMemD = 1, CXBinaryOperator_PtrMemI = 2, CXBinaryOperator_Mul = 3, CXBinaryOperator_Div = 4, CXBinaryOperator_Rem = 5, CXBinaryOperator_Add = 6, CXBinaryOperator_Sub = 7, CXBinaryOperator_Shl = 8, CXBinaryOperator_Shr = 9, CXBinaryOperator_Cmp = 10, CXBinaryOperator_LT = 11, CXBinaryOperator_GT = 12, CXBinaryOperator_LE = 13, CXBinaryOperator_GE = 14, CXBinaryOperator_EQ = 15, CXBinaryOperator_NE = 16, CXBinaryOperator_And = 17, CXBinaryOperator_Xor = 18, CXBinaryOperator_Or = 19, CXBinaryOperator_LAnd = 20, CXBinaryOperator_LOr = 21, CXBinaryOperator_Assign = 22, CXBinaryOperator_MulAssign = 23, CXBinaryOperator_DivAssign = 24, CXBinaryOperator_RemAssign = 25, CXBinaryOperator_AddAssign = 26, CXBinaryOperator_SubAssign = 27, CXBinaryOperator_ShlAssign = 28, CXBinaryOperator_ShrAssign = 29, CXBinaryOperator_AndAssign = 30, CXBinaryOperator_XorAssign = 31, CXBinaryOperator_OrAssign = 32, CXBinaryOperator_Comma = 33, }
CXUnaryOperatorKind :: enum i32 {CXUnaryOperator_Invalid = 0, CXUnaryOperator_PostInc = 1, CXUnaryOperator_PostDec = 2, CXUnaryOperator_PreInc = 3, CXUnaryOperator_PreDec = 4, CXUnaryOperator_AddrOf = 5, CXUnaryOperator_Deref = 6, CXUnaryOperator_Plus = 7, CXUnaryOperator_Minus = 8, CXUnaryOperator_Not = 9, CXUnaryOperator_LNot = 10, CXUnaryOperator_Real = 11, CXUnaryOperator_Imag = 12, CXUnaryOperator_Extension = 13, CXUnaryOperator_Coawait = 14, }
anon_9 :: #type proc "c" (param0: rawptr)
size_t :: u64
CXRewriter :: rawptr
...
foreign clang_runic {
    ...
    getFileContents :: proc(tu: CXTranslationUnit, file: CXFile, size: ^size_t) -> cstring ---
    ...
    executeOnThread :: proc(fn: anon_9, user_data: rawptr, stack_size: u32) ---
