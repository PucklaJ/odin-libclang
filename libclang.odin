...
foreign clang_runic {
    ...
    isBeforeInTranslationUnit :: proc(loc1: SourceLocation, loc2: SourceLocation) -> u32 ---
    ...
    getOffsetOfBase :: proc(Parent: Cursor, Base: Cursor) -> i64 ---
    ...
    getTypePrettyPrinted :: proc(CT: Type, cxPolicy: PrintingPolicy) -> String ---
    ...
    visitCXXBaseClasses :: proc(T: Type, visitor: FieldVisitor, client_data: ClientData) -> u32 ---
